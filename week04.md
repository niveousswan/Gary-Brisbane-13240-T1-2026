...
2.2 Simple Block Cipher  
Encrypt random 5-bit plaintext using SBC and a random 3-bit key. What is the ciphertext?  
Plaintext: 10101  
Key: 011  
Ciphertext: 00011  
Decrypt the ciphertext 11111 using SBC and a random 3-bit key. What is the plaintext?  
Ciphertext: 11111  
Key: 010  
Plaintext: 00011  

2.3 SBC in CBC Mod - Encrypt P1 using SBC in CBC mode with K1 and IV1. What is the ciphertext, C1?
A = 10101, B = 01011  
...
2.4 SBC in CTR Mod - Encrypt P1 using SBC in CTR mode with K1 and IV1. What is the ciphertext, C2?
K1 = 011, IV1 = 00110  
...
2.5 Compare Modes of Operation  
